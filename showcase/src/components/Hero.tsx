      ...
      >
        ...
        >
          <span className="badge-text">
            🍎 Powerful Clipboard Manager for macOS
          </span>
        </motion.div>
        ...
        >
          Smart clipboard tracking with instant search, keyboard navigation, and rich previews.
          <br />
        ...
        >
          <a
            href="https://github.com/Digital-Defiance/Kliply/releases/tag/v1.0.6"
